...
<head>
    ...
    <title>Tambah Menu Rekomendasi</title>
...
<body>
  <div>
    <div class="kotak">
      <form enctype="multipart/form-data" method="POST" action="insertRekomProses.php">
        <div class="container">
          <div class="container2">
            <H2><center>Tambah Menu Rekomendasi</center></H2> 
            <div class="row">
              <div class="col-25">
            ...
            <div class="row">
              <div class="col-25">
                <label for="nama"><b>Nama Rekomendasi</b></label>
              </div>
              <div class="col-75">
                <input type="text" name="namarekomendasi" placeholder="Nama Menu rekomendasi.."><br>
              </div>
            </div>
            <div class="row">
              <div class="col-25">
